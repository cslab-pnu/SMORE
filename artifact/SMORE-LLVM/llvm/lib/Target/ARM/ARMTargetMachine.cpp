...
EnableInsertRedzone("enable-arm-insert-redzone",
                         cl::desc("Enable insert redzone in MSP stack pass"),
                         cl::location(InsertRedzone),
...
void ARMPassConfig::addPreEmitPass2() {
  ...
  if(EnableInsertRedzone){
    addPass(createARMInsertRedzone());
  }
}
