...
//
unsigned
ARMInstrumentor::getITBlockSize(const MachineInstr & IT) {
...
//
MachineInstr *
ARMInstrumentor::findIT(MachineInstr & MI, unsigned & distance) {
...
//
const MachineInstr *
ARMInstrumentor::findIT(const MachineInstr & MI, unsigned & distance) {
...
//
void
ARMInstrumentor::insertInstBefore(MachineInstr & MI,
                                            MachineInstr * Inst) {
...
//
void
ARMInstrumentor::insertInstAfter(MachineInstr & MI,
                                           MachineInstr * Inst) {
...
//
void
ARMInstrumentor::insertInstsBefore(MachineInstr & MI,
...
//
void
ARMInstrumentor::insertInstsAfter(MachineInstr & MI,
                                            ArrayRef<MachineInstr *> Insts) {
  assert(!MI.isMetaInstruction() && "Cannot instrument meta instruction!");
...
//
void
ARMInstrumentor::removeInst(MachineInstr & MI) {
  assert(!MI.isMetaInstruction() && "Cannot instrument meta instruction!");
...
//
std::deque<bool>
ARMInstrumentor::decodeITMask(unsigned Mask) {
  Mask &= 0xf;
  assert(Mask != 0 && "Invalid IT mask!");
...
//
unsigned
ARMInstrumentor::encodeITMask(std::deque<bool> DQMask) {
...
//
std::vector<Register>
ARMInstrumentor::findFreeRegistersBefore(const MachineInstr & MI,
                                                   bool Thumb) {
  assert(!MI.isMetaInstruction() && "Cannot instrument meta instruction!");
...
//
std::vector<Register>
ARMInstrumentor::findFreeRegistersAfter(const MachineInstr & MI,
                                                  bool Thumb) {
  assert(!MI.isMetaInstruction() && "Cannot instrument meta instruction!");
