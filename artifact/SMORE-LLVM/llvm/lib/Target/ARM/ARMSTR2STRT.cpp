...
char ARMSTR2STRT::ID = 0;

ARMSTR2STRT::ARMSTR2STRT()
    : MachineFunctionPass(ID) {
}

StringRef
ARMSTR2STRT::getPassName() const {
...
//
bool
ARMSTR2STRT::runOnMachineFunction(MachineFunction & MF) {
#if 1
  // Skip privileged functions
  if (MF.getFunction().getName().equals("reset_handler_default") || MF.getFunction().getName().equals("cortexm_init")) {
