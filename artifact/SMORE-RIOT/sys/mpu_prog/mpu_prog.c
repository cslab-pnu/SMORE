...
int setMPU(unsigned int region, void* baseAddress, void* limitAddress, unsigned int rw, unsigned int ex, unsigned int priv_level){
    ...
    */
    ...
    ARM_MPU_SetRegion(region,
      ARM_MPU_RBAR(base, ARM_MPU_SH_NON, rw, priv_level, ex),  /* Non-shareable, read/write, non-privileged, execute-never */
