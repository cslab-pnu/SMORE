...
psa_status_t psa_get_and_lock_key_slot(psa_key_id_t id, psa_key_slot_t **p_slot)
{
	__asm__ volatile(
		...
		"ldr.w	r12, [r2, #8]	\n"
		"cmp.w	r12, #0			\n"
		"beq	psa_get_and_lock_key_slot1	\n"
		"mov	r2, r12			\n"
		"psa_get_and_lock_key_slot0:		\n"
		"ldr	r2, [r2, #0]	\n"
		"ldr	r3, [r2, #16]	\n"
		"cmp	r3, r0			\n"
		"beq.n	psa_get_and_lock_key_slot2	\n"
		"cmp	r2, r12			\n"
		"beq.n	psa_get_and_lock_key_slot1	\n"
		"ldr	r2, [r2, #0]	\n"
		"ldr	r3, [r2, #16]	\n"
		"cmp	r3, r0			\n"
		"beq.n	psa_get_and_lock_key_slot2	\n"
		...
		"mvneq.w r0, #135		\n"
		"bxeq	lr				\n"
		"b.n	psa_get_and_lock_key_slot0	\n"
		"psa_get_and_lock_key_slot1:		\n"
		"mvn.w	r0, #135		\n"
		"bx		lr				\n"
		"nop					\n"
		"psa_get_and_lock_key_slot2:		\n"
		"ldr	r0, [r2, #4]	\n"
		"adds	r0, #1			\n"
		"iteee	cs				\n"
		"mvncs.w r0, #150		\n"
