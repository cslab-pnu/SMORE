...
//extern int _EXFUN(__swrite,(struct _reent *, void *, const char *, int));

/**
 * @brief   Allocation of the interrupt stack
 */
__attribute__((used,section(".isr_stack"))) uint8_t isr_stack[32768];	

/**
 * @brief   Pre-start routine for CPU-specific settings
 */
__attribute__((weak, no_stack_protector)) void pre_startup (void)
{
}
 ...
 */
__attribute__((weak, no_stack_protector)) void post_startup (void)
{
}
...
void reset_handler_default(void)
{
	...
	// bitmap reset
	for (int i=0x20; i<0x400; i+=4) 
		*(volatile int*)(0x20000000+i) = 0;

#ifdef SMORE_EXT
    // store poison value
    *(volatile int*) 0x20000000 = 0x12345678;
    *(volatile int*) 0x20000004 = 0x23456781;
    *(volatile int*) 0x20000008 = 0x34567812;
    *(volatile int*) 0x2000000c = 0x45678123;
    *(volatile int*) 0x20000010 = 0x56781234;
    *(volatile int*) 0x20000014 = 0x67812345;
    *(volatile int*) 0x20000018 = 0x78123456;
    *(volatile int*) 0x2000001c = 0x81234567;
#endif
	...
	__asm__ volatile(
		...
		// region 5: un-overlapped region + global/heap
		"movw	r5, #0x8003			\n" // RWXN = 3
		"movt	r5, #0x2000			\n" // 0x20008003
		"str	r5, [r4, #12]		\n"
		"movw	r5, #0xffff			\n"
    ...
    //*(volatile unsigned *)0xe000ed24 |= 0xf0000;

	// set dwt to protect system control block
	DWT_FUNCTION0 |= 0x15;
	DWT_COMP0 = 0xe000ed94;
	DWT_FUNCTION1 |= 0x17;
	DWT_COMP1 = 0xe000edb8;
...
__attribute__((used)) void hard_fault_handler(uint32_t* sp, uint32_t corrupted, uint32_t exc_return,
                                              uint32_t* r4_to_r11_stack)
{
	int mem = (*(volatile int*)0xe000ed28) & 0xff;
	if (mem == 0x82) printf("\n\n\nredzone detected!\n\n\n");
	else printf("non redzone fault\n");
...
{
	int flag = (*(volatile int*)0xe000ed28);
	if (flag == 0x82) {
		printf("mem_manage_default\n");
		core_panic(PANIC_MEM_MANAGE, "MEM MANAGE HANDLER");
	}
	else hard_fault_default();
    ...
    (
        ...
        "ldrb   r4, [r5]        \n"
        "cmp    r4, #1          \n"
        "beq    exit_mem_fault  \n" // get bitmap value and check redzone
        ...
        /*
        "ldr    r5, [sp, #4]    \n"
        "ldrh   r4, [r5]        \n" // load error instruction

        "lsr    r5, r4, #12     \n"
        "and    r5, r5, #7      \n" // get instruction bit (inst >> 12) & 0x7
...
{
	printf("detected invalid control flow or stack check failed\n");
